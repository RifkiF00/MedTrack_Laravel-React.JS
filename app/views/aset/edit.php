<div class="container" style="max-width: 900px; margin: 30px auto; padding: 0 20px;">
    ...
    <form action="<?= BASEURL; ?>/aset/update/<?= $data['aset']['id_aset']; ?>" method="POST" style="background:#fff; border:1px solid #ddd; border-radius:12px; padding:24px;">
            ...
            <div style="grid-column:1 / -1; background:#f8fafc; border:1px solid #e5e7eb; border-radius:12px; padding:16px;">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                    <div>
                        ...
                        <input
                            ...
                            name="latitude"
                            id="latitude"
                            value="<?= escape($data['aset']['latitude'] ?? ''); ?>"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="longitude"
                            id="longitude"
                            value="<?= escape($data['aset']['longitude'] ?? ''); ?>"
                ...
                <div style="margin-top:12px; display:flex; gap:10px; flex-wrap:wrap;">
                    ...
                    <span id="gps-status" style="align-self:center; color:#6b7280; font-size:14px;">
                        <?= !empty($data['aset']['latitude']) && !empty($data['aset']['longitude']) ? 'Koordinat sudah tersedia.' : 'Belum ada koordinat.'; ?>
                    </span>
                </div>
        ...
        <div style="margin-top:20px; display:flex; justify-content:flex-end; gap:10px;">
            <a href="<?= BASEURL; ?>/aset" style="padding:10px 16px; background:#6c757d; color:#fff; border-radius:8px; text-decoration:none;">Batal</a>
