...
export default function Create({ auth, ruangans }) {
    ...
    useEffect(() => {
        ...
        const L = window.L;
        // Default Kuningan RS coordinates
        const lat = -6.9744;
        const lng = 108.4773;

        const map = L.map('leaflet-create-map').setView([lat, lng], 15);
        ...
        // Initialize coordinates in form
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    <div>
                        <h2 className="font-extrabold text-2xl text-slate-800 leading-tight">Registrasi Aset Baru</h2>
                        <p className="text-xs text-slate-500 mt-1">Tambahkan informasi alat medis dan sarana prasarana baru</p>
                    </div>
                    <Link
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Contoh: Defibrillator Mindray"
                                className="mt-1.5 w-full border-0 bg-slate-50 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                required
                            />
                        ...
                        {/* Status Kondisi */}
                        <div>
                            <label className="block text-sm font-bold text-slate-700">Status Kondisi Awal *</label>
                            <select
                        ...
                        <div>
                            ...
                            {errors.id_ruang_saat_ini && <p className="text-rose-500 text-xs mt-1">{errors.id_ruang_saat_ini}</p>}
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="md:col-span-3">
                                <div className="border border-slate-200 rounded-xl overflow-hidden relative z-0">
                                    <div id="leaflet-create-map" className="w-full h-64 bg-slate-50"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                {imagePreview && (
                                    <div className="mt-4 max-w-[200px]">
                                        <span className="text-xs text-slate-400 block mb-1">Preview Gambar</span>
